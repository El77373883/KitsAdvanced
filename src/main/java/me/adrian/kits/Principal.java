...
public class Principal extends JavaPlugin implements Listener {
    ...
    public void onEnable() {
        if (!setupEconomy()) getLogger().severe("¡Vault no encontrado! La economía no funcionará.");
        ...
        Bukkit.getConsoleSender().sendMessage(c("&b&l▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"));
    ...
    private void cargarConfigPredeterminada() {
        ...
        config.addDefault("Bienvenida.mensaje", Arrays.asList(
            "&b&l▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬",
            "{prefix} &f¡Bienvenido, &b{player}&f!",
        ...
        public boolean onCommand(CommandSender s, Command cmd, String l, String[] a) {
            ...
            if (a[0].equalsIgnoreCase("reload")) {
                if (p.hasPermission("kitsadvanced.admin")) {
                    reloadConfig();
                    p.sendMessage(c(getPrefix() + msg("&a¡Configuración recargada!", "&a¡Reloaded!")));
                } else p.sendMessage(c(getPrefix() + "&cNo tienes permiso."));
                return true;
            }

            p.sendMessage(c("&b&l" + getPrefix()));
            p.sendMessage(c("&7/akits &8- &fAbrir menú de kits."));
            if (p.hasPermission("kitsadvanced.admin")) {
                p.sendMessage(c("&7/akits admin &8- &fPanel de administración."));
                p.sendMessage(c("&7/akits reload &8- &fRecargar configuración."));
            }
            return true;
        }
    }
    ...
    public void abrirMenuKits(Player p) {
        ...
        inv.setItem(49, createItem(Material.NETHER_STAR, msg("&e&lCATEGORÍA", "&e&lCATEGORY"), true, msg("&7Viendo: &f", "&7Viewing: &f") + cat));
    ...
    public void abrirOpcionesKit(Player p, String k) {
        ...
        inv.setItem(13, createItem(Material.REDSTONE, msg("&d&l4. CATEGORÍA", "&d&l4. CATEGORY"), cf.getBoolean("requiere-permiso"), "Premium: " + cf.getBoolean("requiere-permiso")));
        ...
        inv.setItem(49, createItem(Material.ARROW, msg("&c« VOLVER", "&c« BACK"), false));
        p.openInventory(inv);
    }
            ...
            switch (e.getRawSlot()) {
                ...
                case 15: 
                    if (p.getInventory().getItemInMainHand().getType() != Material.AIR) {
                        ...
                        guardarKit(k, cf); p.sendMessage(c(getPrefix() + msg("&a¡Icono cambiado!", "&a¡Icon changed!")));
    ...
    private void darKit(Player p, String k) {
        ...
        if (items != null) {
            ...
            p.sendMessage(c(getPrefix() + msg("&a¡Kit recibido!", "&a¡Kit received!")));
        }
    }
    ...
    public void alChat(AsyncPlayerChatEvent e) {
        ...
        Bukkit.getScheduler().runTask(this, () -> {
            ...
            try {
                ...
                p.sendMessage(c(getPrefix() + "&c¡Error! Entrada no válida (¿pusiste letras en vez de números?)."));
